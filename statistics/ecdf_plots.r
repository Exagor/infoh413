...
legend("topleft", legend=c("250s","175s","100s"), lty=c(1,2,3), col=c("black","black","black"), bty="n",inset = c(0, 0.05),cex=1.4)
...
legend("topleft", legend=c("ILS","MA"), lty=1, col=c("#00ff5e","#ff0000"), bty="n",inset = c(0, 0.05),cex=1.4)
